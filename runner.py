...
def main() -> int:
    ...
    required=['YOUTUBE_API_KEY','TELEGRAM_BOT_TOKEN','TELEGRAM_CHAT_ID']
    ...
    tg=TelegramClient(os.environ['TELEGRAM_BOT_TOKEN'],os.environ['TELEGRAM_CHAT_ID'],http)
    return Pipeline(load_people(),yt,sp,tg,StateStore(),HealthStore(),dry_run=args.mode=='debug').run()
